package ca.hojat.messenger.niki.feature_about
...
import ca.hojat.messenger.niki.shared.ui.compose.settings.SettingsHorizontalDivider
import ca.hojat.messenger.niki.shared.ui.compose.theme.AppThemeSurface
import ca.hojat.messenger.niki.shared.ui.compose.extensions.MyDevices
import ca.hojat.messenger.niki.shared.ui.compose.lists.SimpleLazyListScaffold
import ca.hojat.messenger.niki.shared.ui.compose.theme.SimpleTheme
import ca.hojat.messenger.niki.shared.helpers.LICENSE_ANDROID_LAME
import ca.hojat.messenger.niki.shared.helpers.LICENSE_APNG
import ca.hojat.messenger.niki.shared.helpers.LICENSE_AUDIO_RECORD_VIEW
import ca.hojat.messenger.niki.shared.helpers.LICENSE_AUTOFITTEXTVIEW
import ca.hojat.messenger.niki.shared.helpers.LICENSE_CROPPER
import ca.hojat.messenger.niki.shared.helpers.LICENSE_ESPRESSO
import ca.hojat.messenger.niki.shared.helpers.LICENSE_EVENT_BUS
import ca.hojat.messenger.niki.shared.helpers.LICENSE_EXOPLAYER
import ca.hojat.messenger.niki.shared.helpers.LICENSE_FILTERS
import ca.hojat.messenger.niki.shared.helpers.LICENSE_GESTURE_VIEWS
import ca.hojat.messenger.niki.shared.helpers.LICENSE_GIF_DRAWABLE
import ca.hojat.messenger.niki.shared.helpers.LICENSE_GLIDE
import ca.hojat.messenger.niki.shared.helpers.LICENSE_GSON
import ca.hojat.messenger.niki.shared.helpers.LICENSE_INDICATOR_FAST_SCROLL
import ca.hojat.messenger.niki.shared.helpers.LICENSE_JODA
import ca.hojat.messenger.niki.shared.helpers.LICENSE_KOTLIN
import ca.hojat.messenger.niki.shared.helpers.LICENSE_LEAK_CANARY
import ca.hojat.messenger.niki.shared.helpers.LICENSE_M3U_PARSER
import ca.hojat.messenger.niki.shared.helpers.LICENSE_NUMBER_PICKER
import ca.hojat.messenger.niki.shared.helpers.LICENSE_OTTO
import ca.hojat.messenger.niki.shared.helpers.LICENSE_PANORAMA_VIEW
import ca.hojat.messenger.niki.shared.helpers.LICENSE_PATTERN
import ca.hojat.messenger.niki.shared.helpers.LICENSE_PDF_VIEWER
import ca.hojat.messenger.niki.shared.helpers.LICENSE_PDF_VIEW_PAGER
import ca.hojat.messenger.niki.shared.helpers.LICENSE_PHOTOVIEW
import ca.hojat.messenger.niki.shared.helpers.LICENSE_PICASSO
import ca.hojat.messenger.niki.shared.helpers.LICENSE_REPRINT
import ca.hojat.messenger.niki.shared.helpers.LICENSE_ROBOLECTRIC
import ca.hojat.messenger.niki.shared.helpers.LICENSE_RTL
import ca.hojat.messenger.niki.shared.helpers.LICENSE_SANSELAN
import ca.hojat.messenger.niki.shared.helpers.LICENSE_SMS_MMS
import ca.hojat.messenger.niki.shared.helpers.LICENSE_STETHO
import ca.hojat.messenger.niki.shared.helpers.LICENSE_SUBSAMPLING
import ca.hojat.messenger.niki.shared.helpers.LICENSE_ZIP4J
import ca.hojat.messenger.niki.shared.data.models.License
